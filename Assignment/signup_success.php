...
if($conn->connect_error){
  die("Connection failed: ".$conn->connect_error);
	...
	$dbquery = "insert into USERS (username, password, email, status, user_type)
				values ('".$username."', '".$password."', '".$email."', 'active', 'user')";
...
?>
			...
			<?php
			echo "<p style='color:blue;'>Success Register New User</p>";
			?>
			</div>
			<br>
		<?php
