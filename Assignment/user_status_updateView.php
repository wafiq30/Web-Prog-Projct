...
.update-button {
	...
	<?php
		...
		if ($conn -> connect_error) {
			...
			$queryview = "SELECT * FROM USERS WHERE user_type = 'user'";
			$resultQ = $conn -> query($queryview);
		}
	?>
<body>
<center>
	<h1 style="border: 5px solid White; padding: 10px; display: inline-block; width: auto; font-family: Cavolini, Cambria, Arial;">&#127925; User Status List &#127926;</h1>

	<form action="user_statusUpdate.php" method="POST" onsubmit="return confirm('Are you sure to edit this record?')">
	...
	?>
	<tr>
		<td> <input type="radio" name="userid" value=<?php echo $row["user_id"]; ?> required style="width:20px;height:15px;"> </td>
		<td style="width:200px;"><center><?php echo $row["username"]; ?></center></td>
		<td style="width:500px;"><center><?php echo $row["email"]; ?></center></td>
